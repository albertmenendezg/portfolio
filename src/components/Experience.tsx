    ...
    <section id="experience" className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="text-gray-600 dark:text-gray-400 text-justify text-lg mb-12 max-w-4xl mx-auto"
        >
              ...
              >
                ...
                <div className="flex-1 space-y-4">
                  <motion.div
                    ...
                    className="bg-white dark:bg-gray-950 p-5 rounded-lg border border-gray-200 dark:border-gray-800 cursor-pointer"
                  >
