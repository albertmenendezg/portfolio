...
const About = () => {
  return (
    <section id='about' className='min-h-screen w-full pt-10 pb-20 px-5 flex flex-row border-b border-gray-900 rounded-md gap-x-16'>
        <div className='w-1/2 h-100 flex bg-gray-700 rounded-xl items-center justify-center'>
            <Image 
                src={logo}
                alt='Albert Menéndez'
                className='p-24 w-full h-full rounded-full'
            />
        </div>
        <div className='w-1/2 h-100'>
            <h3 className='text-3xl font-bold'>Hi, I am Albert Menéndez Fullstack Developer.</h3>
