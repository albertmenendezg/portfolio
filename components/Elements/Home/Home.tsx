        ...
        <section id='home' className='min-h-screen w-full pt-20 pb-40 px-5 flex flex-row border-b border-gray-900 rounded-md gap-4'>
            <div className='w-1/2 flex flex-col gap-24'>
                <div className='flex flex-col gap-8'>
                    <h4 className='text-2xl font-normal'>Welcome to my Portfolio</h4>
                    ...
                    <p className='text-xl w-1/2 text-justify'>Focused in writting clean and efficient code and love finding out new software techniques.</p>
                </div>
                <div className='w-full'>
                    ...
                    <div className='flex flex-row gap-10 justify-evenly'>
                        <NextLink href={TwitterUrl} target='_blank'>
                            <AiFillTwitterCircle className='text-7xl cursor-pointer'/>
                        </NextLink>
                        <NextLink href={LinkedInUrl} target='_blank'>
                            <AiFillLinkedin className='text-7xl cursor-pointer' />
                        </NextLink>
                        <NextLink href={GitHubUrl} target='_blank'>
                            <AiFillGithub className='text-7xl cursor-pointer' />
                        </NextLink>
                    </div>
                </div>
                <div className='flex mx-auto text-3xl py-4 px-7 bg-red-500 rounded hover:text-black'>
                    <Link
                        to='about'
                        smooth={true}
                        offset={-70}
            ...
            <div className='w-1/2 h-100 flex items-center justify-center overflow-hidden'>
                <Image 
                    src={logo} 
                    alt='Albert Menéndez'
